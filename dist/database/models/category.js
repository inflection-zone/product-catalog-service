...
let Category = exports.Category = (() => {
    ...
    let _parentCategoryId_decorators;
    let _parentCategoryId_initializers = [];
    var Category = _classThis = class {
        constructor() {
            ...
            this.parentCategoryId = __runInitializers(this, _parentCategoryId_initializers, void 0);
        }
    };
    ...
    (() => {
        ...
        _parentCategoryId_decorators = [(0, typeorm_1.ManyToOne)(() => Category)];
        ...
        __esDecorate(null, null, _parentCategoryId_decorators, { kind: "field", name: "parentCategoryId", static: false, private: false, access: { has: obj => "parentCategoryId" in obj, get: obj => obj.parentCategoryId, set: (obj, value) => { obj.parentCategoryId = value; } } }, _parentCategoryId_initializers, _instanceExtraInitializers);
